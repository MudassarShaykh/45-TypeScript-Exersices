...
function make_album(artist:string, albumTitle:string, tracks?:number){
    ...
    const album:{artist:string, albumTitle:string, tracks?:number} = {
            artist : artist,
    ...
    const album1 = make_album("Mudassar1", "Programming1");
    console.log(album1);

    const album2 = make_album("Mudassar2", "Programming2");
    console.log(album2);

    const album3 = make_album("Mudassar3", "Programming3", 25);
    console.log(album3);
